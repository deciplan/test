...
function render(){
  ...
  /* Mettre à jour th sticky avec couleur thème */
  ...
  tbody.innerHTML=rows.map(function(r){
    ...
    /* Styles inline sur td sticky → priorité absolue */
    ...
    var c1='<td style="'+s2+'"><div class="school-name">'+r.nom+'</div>'+nd+'</td>';
